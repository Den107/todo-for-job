...
const TodoComplete = ({importance, title, description, id}) => {
    ...
    return (
        <div className="list__todo todo todo--complete">
            <h3>
            ...
            <button className="todo__complete-button">Вернуть</button>
            {chooseImportance()}
            <div>
                <button><i className="fa-solid fa-trash" style={{color: '#cd1326'}}></i></button>
